...
int main() {
    ...
    std::string filename = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/03_Case study - PCL- zad_2_2/results/04_1_cloud_5.pcd";
    ...
    // PassThrough po x osi
    pcl::PassThrough<pcl::PointXYZRGB> pass;
    pass.setInputCloud(original_cloud);
    pass.setFilterFieldName("x");
    pass.setFilterLimits(-0.03, 0.06);  // promijeni po potrebi
    pass.filter(*filtered_cloud);

    std::cout << "\nFiltrirano točaka: " << filtered_cloud->points.size() << std::endl;
    print_bounds(filtered_cloud, "Nakon filtriranja");

    std::string output_file = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/03_Case study - PCL- zad_2_2/results/04_2_cloud_5.pcd";
