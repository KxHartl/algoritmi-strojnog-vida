...
int main() {
    ...
    std::string input_file = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/03_Case study - PCL- zad_2_2/results/04_2_cloud_5.pcd";
    ...
    sor.setMeanK(1000);               // broj susjeda za računanje prosjeka
    sor.setStddevMulThresh(2);    // prag standardne devijacije
    ...
    std::string output_file = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/03_Case study - PCL- zad_2_2/results/05_2_cloud_5.pcd";
