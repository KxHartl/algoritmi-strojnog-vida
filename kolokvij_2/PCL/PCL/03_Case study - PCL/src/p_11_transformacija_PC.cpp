...
int main() {
    ...
    if (pcl::io::loadPCDFile("/home/asvtara/pcl_ws_prof/data/asv_dataset/scene_01_obradeno/cloud_1_ransac_clean_ptf.pcd", *cloud1) == -1) {
    ...
    if (pcl::io::loadPCDFile("/home/asvtara/pcl_ws_prof/data/asv_dataset/scene_01_obradeno/cloud_4_ransac_clean_ptf_y.pcd", *cloud2) == -1) {
    ...
    if (!loadMatrixFromTxt("/home/asvtara/pcl_ws_prof/data/asv_dataset/scene_01/cloud_1.txt", T_base_tcp_1)) return -1;
    if (!loadMatrixFromTxt("/home/asvtara/pcl_ws_prof/data/asv_dataset/scene_01/cloud_4.txt", T_base_tcp_2)) return -1;
    if (!loadMatrixFromTxt("/home/asvtara/pcl_ws_prof/data/asv_dataset/D405 ekstrinzicna.txt", T_tcp_cam)) return -1;
    ...
    // Spremi rezultate 
    pcl::io::savePCDFileBinary("/home/asvtara/pcl_ws_prof/data/asv_dataset/scene_01_obradeno/transformed_cloud_1.pcd", *cloud1_trans);
    pcl::io::savePCDFileBinary("/home/asvtara/pcl_ws_prof/data/asv_dataset/scene_01_obradeno/transformed_cloud_2.pcd", *cloud2_trans);
