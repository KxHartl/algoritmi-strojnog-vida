...
int main() {
    ...
    std::string filename = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/03_Case study - PCL/results/10_cloud_4_2.pcd";
    ...
    pass.setFilterLimits(-0.08, 0.01);  // promijeni po potrebi
    pass.filter(*filtered_cloud);

    std::cout << "\nFiltrirano točaka: " << filtered_cloud->points.size() << std::endl;
    print_bounds(filtered_cloud, "Nakon filtriranja");

    std::string output_file = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/03_Case study - PCL/results/10_cloud_4_2_2.pcd";
