...
int main() {
    ...
    std::string input_file = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/01_3D vision and point cloud data/pcl_ws/data/rezultati/cloud_1_sop.pcd";
    ...
    voxel.setLeafSize(0.01f, 0.01f, 0.01f);  // postavi veličinu voxela (1 cm)
    ...
    std::string output_file = "/home/ivan/Desktop/Algoritmi strojnog vida/Kol_2/01_3D vision and point cloud data/pcl_ws/data/rezultati/cloud_1_v.pcd";
